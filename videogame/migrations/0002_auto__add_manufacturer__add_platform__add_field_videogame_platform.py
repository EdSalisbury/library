...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('videogame_manufacturer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('videogame', ['Manufacturer'])

        # Adding model 'Platform'
        db.create_table('videogame_platform', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('manufacturer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videogame.Manufacturer'])),
        ))
        db.send_create_signal('videogame', ['Platform'])

        # Adding field 'VideoGame.platform'
        db.add_column('videogame_videogame', 'platform',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['videogame.Platform']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Manufacturer'
        db.delete_table('videogame_manufacturer')

        # Deleting model 'Platform'
        db.delete_table('videogame_platform')

        # Deleting field 'VideoGame.platform'
        db.delete_column('videogame_videogame', 'platform_id')
    ...
    models = {
        ...
        'videogame.platform': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manufacturer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['videogame.Manufacturer']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
        'videogame.publisher': {
