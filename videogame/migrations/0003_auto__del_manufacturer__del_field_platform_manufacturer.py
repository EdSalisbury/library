...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Platform.manufacturer'
        db.delete_column('videogame_platform', 'manufacturer_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Platform.manufacturer'
        db.add_column('videogame_platform', 'manufacturer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['videogame.Manufacturer']),
                      keep_default=False)
